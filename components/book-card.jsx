  ...
  return (
    <>
      <Link href={highlights_url}>
        <div className=" w-full shadow-md lg:max-w-full flex">
          <div className="relative my-2 w-32 bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden">
